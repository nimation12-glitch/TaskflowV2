...
import { NAV, ADMIN_NAV_ITEM } from "./nav-config";

export function Sidebar({ admin, onNavigate }: { admin?: boolean; onNavigate?: () => void }) {
  const pathname = usePathname();
  const items = admin ? [...NAV, ADMIN_NAV_ITEM] : NAV;
